...
export const aboutData: aboutType[] = [
  {
    title: "Health",
    description:
      "Aside from school and programming, here are a few things that I spend my time on. A big goal of mine is to build a good physique. I don't have a specific look in mind; I just want to be relatively lean, strong, and healthy.",
    size: "medium",
  ...
  },
  {
    title: "Cooking",
    description:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas minima quisquam fugiat odio sunt sed reprehenderit temporibus mollitia, assumenda doloribus recusandae dignissimos quia alias rerum.",
    size: "medium",
    imageUrl: "/images/bg2.jpg",
  },
];
...
export const projectData: ProjectCardType[] = [
  ...
  },
  {
    ...
    imageUrl: "/blackPlaceholder.png",
    subtext:
      "Simple java Flask apllication allowing user to manage and organize their Student Systems",
    skills: [
      {
        name: "Python",
...
export const FAQSet: FAQSetType[] = [
  ...
  },
  {
    ...
    Anwser: `Challenges are a normal part of software development. When I encounter a problem, I;\n
