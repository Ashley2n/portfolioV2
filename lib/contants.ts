...
export const tagOptions = {
  ...
  NextJs: {
    name: "Next.js",
    imgaeUrl: "/icons/icons8-nextjs.svg",
    color: "#1c1c1d",
  },
};
...
export const projectData: ProjectCardType[] = [
  {
    title: "portfolioV2",
    imageUrl: "/Homepage-image.png",
    subtext:
      "Full-stack Next.js portfolio with Prisma, Neon PostgreSQL, and a Dockerized dev environment, tested with Vitest and deployed via a 4-check GitHub Actions CI pipeline",
    skills: [
      {
        name: "Next.js",
        imageUrl: tagOptions.NextJs.imgaeUrl,
        color: tagOptions.NextJs.color,
      },
      // Next.js, TypeScript, Prisma, PostgreSQL, Docker, Vitest, GitHub Actions
    ],
    githubUrl: "https://github.com/Ashley2n/portfolioV2",
  },
  {
    title: "DineDirect",
    imageUrl: "/DineDirectImage.png",
    subtext:
      "Full-stack food ordering platform built with a 6-person team, featuring Stripe payment integration and CRUD menu management",
    skills: [
      {
        name: "Next.js",
        imageUrl: tagOptions.NextJs.imgaeUrl,
      ...
      // Next.js, TypeScript, PostgreSQL, Drizzle, Stripe, shadcn/ui
    ],
    githubUrl: "https://github.com/Ashley2n/DineDirect", // still need this — not visible under Ashley2n's public repos
  },
  {
    title: "CookQuest",
    imageUrl: "/CookQuestImage.png",
    subtext:
      "Flask/SQLite game built with a 5-developer team during a 3-day school hackathon, with session-based authentication",
    skills: [
      {
        name: "HTML",
    ...
    githubUrl: "https://github.com/Ashley2n/GreenHorns",
  },
  {
...
export const HomePagePorjectData = projectData.slice(0, 3);
